    ...
    <aside className="flex flex-col h-screen py-6 px-4 w-64 border-r-0 bg-[#eef1f3] dark:bg-slate-900 sticky top-0 hidden lg:flex">
      <div className="flex items-center gap-3 px-2 mb-10">
        ...
        <div>
          ...
          <p className="text-[10px] uppercase tracking-widest text-primary font-bold">AI campus OS</p>
        </div>
      </div>
      ...
      <div className="mt-auto p-4 rounded-2xl bg-surface shadow-sm">
        <p className="text-xs font-bold text-tertiary mb-1">CampusFlow</p>
        <p className="text-[11px] text-on-surface-variant leading-relaxed">
          Feed, placements, tasks, and Gemini — wired to your Express API.
        </p>
      </div>
    </aside>
  );
